...
fn first_three<'a, 'b>(numbers1: &'a Vec<i64>, numbers2: &'b Vec<i64>) -> (&'a[i64], &'b[i64]) {  // Lifetime definition returning slices.
    //  1: You can get slices like this using this syntax:
